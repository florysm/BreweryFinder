...
END
/****** Object:  Database [final_capstone]    Script Date: 12/16/2021 9:49:57 AM ******/
...
USE [final_capstone]
GO
/****** Object:  Table [dbo].[beer_reviews]    Script Date: 12/16/2021 9:49:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[beer_reviews](
...
GO
/****** Object:  Table [dbo].[beers]    Script Date: 12/16/2021 9:49:58 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[breweries]    Script Date: 12/16/2021 9:49:58 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[brewers]    Script Date: 12/16/2021 9:49:58 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 12/16/2021 9:49:58 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[users](
	...
	[favorite_brewery_id] [int] NULL,
	[favorite_style] [nvarchar](50) NULL,
...
GO
SET IDENTITY_INSERT [dbo].[beer_reviews] ON 
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (1, N'Gulpin Good!', N'It was just alright. I drank it so fast, I dont remember.', CAST(2 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 1, 5)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (2, N'Lager? I barely know her!', N'Me and the boys went dahn to the brewry and had a great time! Pretty good!', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 1, 8)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (3, N'What day is it?', N'Not sure how the beer was, but I sure feel it today. My head is killing me, I need a glass of water.', CAST(4 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 90, 7)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (4, N'Not a review from a dog', N'Woof woof bark! I dont drink because Im (not) a dog! Had a really really fun time! Yay!', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 6, 6)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (5, N'Test Review', N'I am just a user leaving a test review. It was good for a test. Thanks.', CAST(3 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 1, 1)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (6, N'Lorem Ipsum', N'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', CAST(1 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 10, 1)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (7, N'FALSE ADVERTISING!!!!!!!!111', N'no flying gnome nowhere what the hell kinda place is this I wanna get spirited away to the fantasy land! also my dog left a review on here somewhere please delete it', CAST(0 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 138, 6)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (8, N'Great Flavor!', N'Tasted just as good on the way up as it did going down!', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 5, 5)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (9, N'Wishful thinking', N'I wish there were 8 days in a week. Unfortunately, I overindulged on this delicious beverage and fell behind at work. Now Im on the outs with my boss and I might lose my job. Great beer though.', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 74, 7)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (10, N'BRO this is good stuff', N'You know Sasquatch means Wild Man of the Woods? This dank drank made ME feel like a WILD MAN WHOOOOA YEAHHHH', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 73, 8)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (11, N'GOOD BEAR', N'Good beer.', CAST(4 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 161, 6)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (12, N'Great dark beer', N'The flavour was good, very malty, and certainly European. Solid 4.0 rating -AdminAndy', CAST(4 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 2, 3)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (13, N'adfad2343134', N'/asdf=bavfdsa', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 35, 6)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (14, N'please help', N'anybody got any ideas on how to get my dog to stop leaving reviews on this website thanks?', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 1, 5)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (15, N'LIFE CHANGING.', N'This beer was so good, it inspired me to start brewing myself and now I dont even care if I lose my job from being hungover every day!', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 54, 7)
GO
INSERT [dbo].[beer_reviews] ([review_id], [subject], [description], [rating], [date], [beer_id], [user_id]) VALUES (16, N'Great beer in moderation', N'Moderation pun, because Im a mod. Get it? Anyway, the reviews on here are getting pretty out of hand. We need some help here on the admin team if anybody is interested.', CAST(5 AS Decimal(18, 0)), CAST(N'2021-12-15' AS Date), 60, 4)
GO
SET IDENTITY_INSERT [dbo].[beer_reviews] OFF
GO
...
GO
INSERT [dbo].[breweries] ([brewery_id], [name], [street_address], [city], [zip_code], [phone_number], [website_url], [social_url], [description], [is_pet_friendly], [logo_url], [taproom_picture], [is_active]) VALUES (9, N'Roundabout Brewery', N'4901 Butler St', N'Pittsburgh', N'15201', N'412-621-0540', N'https://roundaboutbeer.com/', N'https://www.instagram.com/roundaboutbrew/?hl=en', N'Small tasting room located in Pittsburgh neighborhood of Lawrenceville. Currently selling 4pk cans to go only', 0, N'https://roundaboutbeer.com/wp-content/uploads/2013/04/cropped-cropped-Roundabout-Brewery-the-one2.jpg', N'https://s3-media0.fl.yelpcdn.com/bphoto/g_kSPa5DeIijYHYKDs6bYA/o.jpg', 1)
GO
...
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (1, N'user', N'Jg45HuwT7PZkfuKTz6IB90CtWY4=', N'LHxP4Xh7bN0=', N'user', N'user@user.com', 1, 24, N'Pittsburgh', 2, N'IPA', CAST(N'2021-12-15' AS Date), N'https://static.wikia.nocookie.net/trailerpark/images/f/f5/Lahey.jpg/revision/latest?cb=20091104161132')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (2, N'admin', N'YhyGVQ+Ch69n4JMBncM4lNF/i9s=', N'Ar/aB2thQTI=', N'admin', N'admin@admin.com', 1, 34, N'Allentown', 3, N'Doulbe IPA', CAST(N'2021-12-15' AS Date), N'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRupchg0iPX261UaM5uoXeZZVPwoqODGA5q0LWgrRt3MWDdnmwPxM0NrjzvUhlMmjXVn4I&usqp=CAU')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (3, N'adminAndy', N'PqCqDR9hGtyQBE5kOcO/AA8qZzQ=', N'6hTnajV+L5E=', N'admin', N'admin1@findbeer.com', 1, 52, N'Verona', 5, N'Stout', CAST(N'2021-12-15' AS Date), N'https://m.media-amazon.com/images/I/61dysLUUaVL._AC_SY606_.jpg')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (4, N'MonsterMod', N'iXZ3QpaUCYaCiU/YmHsewlR2JwY=', N'+HDyFWS6Bc4=', N'admin', N'admin2@findbeer.com', 1, 67, N'Penn Hills', 12, N'Sours', CAST(N'2021-12-15' AS Date), N'https://i.kym-cdn.com/photos/images/newsfeed/000/012/445/lime-cat.jpg')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (5, N'chugking04', N'5OiyYZ8Pd7jucT+4Bir7wuL1STI=', N'QS9xBrAPTqg=', N'user', N'jimmy@eatworld.com', 1, 54, N'Squirrel Hill', 12, N'Double IPA', CAST(N'2021-12-15' AS Date), N'https://pbs.twimg.com/profile_images/1668286017/Randy-Trailer-Park-Boys_400x400.jpg')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (6, N'goodBoi42', N'CcoQMdfvuLhjv1/WfRsIAdUZs4s=', N'uMzIL2Dgjs4=', N'user', N'notadog@petsmart.com', 1, 25, N'Squirrel Hill', 3, N'Lager', CAST(N'2021-12-15' AS Date), N'https://avatarfiles.alphacoders.com/131/thumb-1920-131408.jpg')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (7, N'hangoverHarry', N'cinOhXK1NiuLvW6A4IP7RrjxrMU=', N'TRwIcEG8IC0=', N'user', N'hydrater@gmail.com', 1, 44, N'Washington', 5, N'Witbier', CAST(N'2021-12-15' AS Date), N'https://i.kym-cdn.com/photos/images/original/000/178/216/1304305090496.jpg')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (8, N'jeagerbro10', N'4sLnEobykg475xm9TOSe3jVbmYQ=', N'hWnvMwSTh7Y=', N'user', N'jeagerbro10@yahoo.com', 1, 41, N'Bellevue', 5, N'Witbier', CAST(N'2021-12-15' AS Date), N'https://static3.srcdn.com/wordpress/wp-content/uploads/2021/06/the-big-lebowski-the-stranger-real-imaginary-narrator.jpg?q=50&fit=crop&w=960&h=500&dpr=1.5')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (9, N'DancingGnome', N'w4PqQRpL3DbrKVvpMGVPoxZHqT8=', N'HuOzUHZiCBw=', N'brewer', N'gnome@dance.com', 1, 23, N'Southside', 7, N'Double IPA', CAST(N'2021-12-15' AS Date), N'http://gwally.com/avatars/images/ricky_150.jpg')
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [email_address], [is_active], [age], [hometown], [favorite_brewery_id], [favorite_style], [date_joined], [profile_picture]) VALUES (10, N'PghBrewer', N'0vPUv7evyqYQh9DFZp/MoX3a0W4=', N'ft27/nyY3Wc=', N'brewer', N'steelerfan@412brew.com', 1, 21, N'North Shore', 16, N'Lager', CAST(N'2021-12-15' AS Date), N'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwmd5YH3R0mg_OPr08Uqx-FQ6Gtm75lPSuzf8p_46Gj4v3oxCVg6OLiwrNMekm6TRWUxM&usqp=CAU')
GO
SET IDENTITY_INSERT [dbo].[users] OFF
GO
ALTER TABLE [dbo].[beer_reviews] ADD  DEFAULT (getutcdate()) FOR [date]
GO
ALTER TABLE [dbo].[breweries] ADD  CONSTRAINT [DF_breweries_is_active]  DEFAULT ((1)) FOR [is_active]
GO
ALTER TABLE [dbo].[users] ADD  CONSTRAINT [DF_users_date_joined]  DEFAULT (getdate()) FOR [date_joined]
GO
ALTER TABLE [dbo].[beer_reviews]  WITH CHECK ADD  CONSTRAINT [FK_event_beer] FOREIGN KEY([beer_id])
REFERENCES [dbo].[beers] ([beer_id])
GO
ALTER TABLE [dbo].[beer_reviews] CHECK CONSTRAINT [FK_event_beer]
GO
ALTER TABLE [dbo].[beer_reviews]  WITH CHECK ADD  CONSTRAINT [FK_event_user] FOREIGN KEY([user_id])
REFERENCES [dbo].[users] ([user_id])
GO
ALTER TABLE [dbo].[beer_reviews] CHECK CONSTRAINT [FK_event_user]
GO
...
GO
ALTER TABLE [dbo].[users]  WITH CHECK ADD  CONSTRAINT [FK_users_breweries] FOREIGN KEY([favorite_brewery_id])
REFERENCES [dbo].[breweries] ([brewery_id])
GO
ALTER TABLE [dbo].[users] CHECK CONSTRAINT [FK_users_breweries]
GO
ALTER TABLE [dbo].[beer_reviews]  WITH CHECK ADD  CONSTRAINT [CHK_duration] CHECK  (([rating]>=(0) AND [rating]<=(5)))
GO
ALTER TABLE [dbo].[beer_reviews] CHECK CONSTRAINT [CHK_duration]
GO
USE [master]
GO

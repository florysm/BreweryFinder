...
namespace Capstone.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Register(RegisterUser userParam)
        {
            ...
            User user = userDao.AddUser(userParam.Username, userParam.Password, userParam.Role, userParam.EmailAddress, userParam.IsActive,userParam.Age, userParam.Hometown,userParam.FavoriteBreweryId,userParam.FavoriteStyle,userParam.ProfilePicture);
            if (user != null)
            {
